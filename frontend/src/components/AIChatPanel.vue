    ...
    >
      ...
      >
        ...
        <template v-if="message.type === 'ai'">
          ...
          <div class="flex-1 rounded-t-xl rounded-br-xl rounded-bl-sm bg-background-tertiary p-3 border border-gray-600">
            <div class="text-white font-inter-regular text-sm whitespace-pre-wrap" v-html="message.content"></div>
      ...
      <div v-if="isLoading" class="flex gap-3 justify-start">
        ...
        <div class="flex-1 rounded-t-xl rounded-br-xl rounded-bl-sm bg-background-tertiary p-3 border border-gray-600">
          <div class="text-text-muted font-inter-regular text-sm">AI is thinking...</div>
        </div>
      </div>
      </div>
    </Transition>
